  ...
  return (
    ...
    >
      ...
      <div
        ...
        className="flex items-center justify-between w-full min-h-11 px-4 py-2 bg-slate-50 dark:bg-slate-800/60 border border-slate-200/80 dark:border-slate-700 rounded-xl cursor-pointer hover:border-emerald-500/50 dark:hover:border-emerald-500/50 transition-colors"
      >
      ...
      {/* Dropdown Panel */}
      {isOpen && (
        <div className="absolute z-30 w-full mt-2 bg-white dark:bg-slate-900 border border-slate-200 dark:border-slate-800 rounded-2xl shadow-xl shadow-slate-950/10 dark:shadow-slate-950/50 animate-in fade-in duration-100 slide-in-from-top-2 overflow-hidden">
          {/* Search Box */}
          <div className="flex items-center gap-2 px-3 py-2.5 border-b border-slate-100 dark:border-slate-800/80">
            ...
            {search && (
              <button
                onClick={() => setSearch("")}
                className="p-0.5 rounded-full hover:bg-slate-100 dark:hover:bg-slate-800"
              >
