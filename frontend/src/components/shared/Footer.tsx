...
export function Footer({ locale }: FooterProps) {
  ...
  return (
    <footer className="bg-slate-900 text-slate-300 border-t border-slate-800" dir={isRTL ? "rtl" : "ltr"}>
      {/* Main Footer */}
      ...
      <div className="border-t border-slate-800 bg-slate-950/30">
        <div className="container-main py-6 flex flex-col sm:flex-row items-center justify-between gap-4 text-xs text-slate-500">
          ...
          <div className="flex gap-4 items-center">
            ...
            <Link href={`/${locale}/privacy`} className="hover:text-slate-300 transition-colors font-medium">
              {locale === "ar" ? "سياسة الخصوصية" : "Privacy Policy"}
            </Link>
            <Link href={`/${locale}/terms`} className="hover:text-slate-300 transition-colors font-medium">
