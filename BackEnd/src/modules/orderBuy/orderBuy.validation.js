...
export const createOrderBuyValidation = {
  body: joi.object({
...
export const updateOrderBuyStatusValidation = {
  params: joi.object({
    id: objectId.required().messages({
      "any.required": "Order id is required",
    }),
...
export const cancelOrderBuyValidation = {
  params: joi.object({
    id: objectId.required().messages({
      "any.required": "Order id is required",
    }),
...
export const getOrdersBuyQueryValidation = {
  query: joi.object({
